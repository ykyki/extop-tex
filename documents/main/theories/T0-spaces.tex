...
\begin{definition}
	...
	2点$ x, y  $について$ x \leq y $かつ$ y \leq x $が成り立つとき, $ x, y $は\indexjj{いそうてきにくべつふのう}{位相的に区別不能}{topologically indistinguishable}あるいは\indexj{どうだい}{同大}であるといい, $ x \topindis y $と書く.
\end{definition}

\begin{definition}
	位相空間$ X $が\indexj{T0 くうかん}{\topT{0}空間}あるいは\indexj{Kolmogorov くうかん}{Kolmogorov 空間}であるとは, $ X $の任意の2点$ x, y $について$ x \topindis y $ならば$ x = y $となることである.
\end{definition}
