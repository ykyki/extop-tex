...
\begin{table}[htb]
	...
	\begin{tabular}{ll@{\qquad}l}
		...
		$\mapsetfamily{f}{\mathscr{U}}$           & \verb|\mapset{f}{\mathscr{U}}|                                                   & 写像$f$による集合族$\mathscr{U}$の順像 \\
		$\mapinvset{h}{K}$                        & \verb|\mapinvset{h}{K}|                                                          & 写像$h$による集合$K$の逆像             \\
		$\mapinvsetfamily{h}{\mathscr{V}}$        & \verb|\mapinvset{h}{\mathscr{V}}|                                                & 写像$h$による集合族$\mathscr{V}$の逆像 \\
