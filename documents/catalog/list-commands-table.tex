...
\begin{table}[htb]
	...
	\begin{tabular}{ll@{\qquad}l}
		...
		$\mapsetfamily{f}{\mathscr{U}}$           & \verb|\mapsetfamily{f}{\mathscr{U}}|                                             & 写像$f$による集合族$\mathscr{U}$の順像 \\
		$\mapinvsetfamily{h}{\mathscr{V}}$        & \verb|\mapinvsetfamily{h}{\mathscr{V}}|                                          & 写像$h$による集合族$\mathscr{V}$の逆像 \\
		...
		$\topballsf{X}{x}{r}$                   & \verb|\topballsf{X}{x}{r}|                   & 距離空間$X$の点$x$を中心する半径$r$の開球               \\
