...
\begin{proof}
	...
	$ X / A $が \topT{1} のとき$ a \in A $に対して$ \{[a]\} \in X / A $は閉集合なので
	...
	$ X $は \topT{4} 空間なので, 開集合$ U_1, U_2 $が存在して$ \mapinvset{\pi}{F_1} \subset U_1 $,
	...
	ともに$ A $と交わらない閉集合である.
	このとき, $ X $が \topT{4} で$ A $が閉集合であることから
	...
	また, \topT{4} 空間は特に \topT{3} 空間なので, \cref{p00005}より
	\topT{1} な$ X / A $はパラコンパクトである.
\end{proof}
